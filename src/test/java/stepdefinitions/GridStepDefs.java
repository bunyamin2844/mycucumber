...
//        driver = new ChromeDriver();
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.8.100:4444"),new ChromeOptions());
    ...
    public void user_is_on_the_application_url_with_firefox() throws MalformedURLException {
        driver = new RemoteWebDriver(new URL("http://192.168.8.100:4444"),new FirefoxOptions());
       // http://192.168.8.100:4444
        driver.manage().window().maximize();
